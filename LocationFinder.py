...
class LocationFinder(object):
    ...
    def disambiguate_places(self, poly_place_list, hint_location="unknown", verbose=False, municipality=False):
        '''
        ...
        for place in c_places.most_common():
            ...
            if hint_location == "unknown":
                ...
                if len(hits) == 0:
                    ...
                    final_places.append((place, (alternatives[0][0], alternatives[0][1]), hits[0][5]))
                #print()
